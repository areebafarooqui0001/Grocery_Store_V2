...
<div class="content">
  ...
  <div class="d-flex justify-content-center " style="margin-top:10vh">
    <div class="container ">
      <h1 align="center">Manager's Dashboard</h1>
      <div class="card mb-3">
        ...
        <table class="table table-striped table-bordered table-hover">  
          ...
          <tbody>
            <tr v-for="product in products" :key="product.id">
              ...
              <td>
                <span style="display: block;">MFG: {{ formatDate(product.manufacture_date) }}</span>
                <span style="display: block;">EXP: {{ formatDate(product.expiry_date) }}</span>
              </td>
